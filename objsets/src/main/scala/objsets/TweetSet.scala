...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet {
  ...
  override def mostRetweeted: Tweet = {
    def maxElement(first: Tweet, second: Tweet): Tweet = {
    ...
    maxElement(elem, maxElement(leftMax, rightMax))
  }
...
//  val t1 = new Tweet("first", "textFirst", 3)
//  val t2 = new Tweet("second", "textSecond", 6)
//  var set1: TweetSet = new NonEmpty(t1, new Empty, new Empty)
//  set1 = set1 incl t2
//
//  val t3 = new Tweet("first", "textFirst_", 1)
//  val t4 = new Tweet("second", "textSecond_", 4)
//  var set2: TweetSet = new NonEmpty(t3, new Empty, new Empty)
//  set2 = set2 incl t4
